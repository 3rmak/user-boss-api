...
COPY public.users (id, email, password, "fullName", "bossId", "roleId") FROM stdin;
\.
...
--
-- Name: users FK_d7c372b53e02ea4c21a45b1867d; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.users
    ADD CONSTRAINT "FK_d7c372b53e02ea4c21a45b1867d" FOREIGN KEY ("bossId") REFERENCES public.users(id);
